...
class IndexView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            context = super(IndexView, self).get_context_data(**kwargs)
            context['sprint_num'] = 0
            context['sprint_completion'] = 0
            context['sprint_completion_subscript'] = '0 / 0'
            context['rca_written_or_not'] = 'N/A'
            context['p0s'] = 0
            context['p1s'] = 0
            context['rate_under_estimated'] = 'N/A'
            context['links'] = 'N/A'

            context['pull_request_notify_panel_data'] = []
            context['pull_request_size_chart_data'] = []
            context['sprint_completion_chart_data'] = []
            return context
